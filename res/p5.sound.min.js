...
!(function (n) {
  ...
  function (t, e, n) {
    ...
    var y = function (t, e, n) {
      ...
      m = [n(27).default, n(28).default, n(29).default],
      v = p.audiocontext,
      _ = !1;
    function g(t, e) {
      if (!(t instanceof e))
    ...
    p5.prototype.registerMethod("init", function () {
      if (!_) {
        ...
        var t = function () {
          (_ = !0), this._decrementPreload();
        }.bind(this);
        Promise.all(
          m.map(function (t) {
            var e = new Blob([t], { type: "application/javascript" }),
              n = URL.createObjectURL(e);
            return v.audioWorklet.addModule(n);
          })
        ).then(t);
      }
    });
        ...
        (function (t, e, n) {
        ...
        })(o, [
          {
            ...
            value: function (n, i) {
              ...
              if (void 0 !== this.url && "" !== this.url) {
                  ...
                  (s.onload = function () {
                    if (200 === s.status) {
                      ...
                      C.decodeAudioData(
                        ...
                        function () {
                          if (r.panner) {
                            var t = new y("decodeAudioData", o, r.url),
                              e =
                ...
                (t.onload = function () {
                  r.panner &&
                    C.decodeAudioData(t.result, function (t) {
                      r.panner &&
                        ((r.buffer = t),
                        r.panner.inputChannels(t.numberOfChannels),
                        n && n(r));
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if ("sustain" === this.mode || "untildone" === this.mode)
                ...
                (this.pauseTime = 0),
                  this.bufferSourceNode.stop(n + e),
                  this._counterNode.stop(n + e),
                  (this._playing = !1),
                  (this._paused = !1);
              }
            },
          ...
          },
          {
            ...
            value: function () {
              return this.reversed
                ? Math.abs(this._lastPos - this.buffer.length) / C.sampleRate
                : this._lastPos / C.sampleRate;
            },
          },
          {
            key: "jump",
          ...
          },
          {
            ...
            value: function () {
              ...
              var t = this._lastPos / C.sampleRate,
                e = this.getVolume();
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.length,
                n = t[0].length,
                i = C.createBuffer(e, n, C.sampleRate);
            ...
            value: function () {
              ...
              return (
                (i.buffer = (function (t) {
                  for (
                    var e = t.length,
                      n = C.createBuffer(1, t.length, C.sampleRate),
            ...
            },
            {
              ...
              value: function () {
                ...
                for (var i = 0; i < this.timeDomain.length; i++) {
                  var r = p5.prototype.map(this.timeDomain[i], 0, 255, -1, 1);
                  e.push(r);
                }
                return e;
              },
              ...
              value: function (t, e) {
                ...
                for (
                  var o = Math.round((t / n) * this.freqDomain.length),
                    s = Math.round((e / n) * this.freqDomain.length),
                    a = 0,
                    u = 0,
                    c = o;
                  c <= s;
    ...
    var $ = (function () {
        ...
        return (
          (function (t, e, n) {
            ...
            },
            {
              ...
              value: function (t) {
                var e = new M.a(t);
                return H(this, e, this.mathOps.length - 1, this.output, M.a);
              },
            },
            {
              key: "mult",
              value: function (t) {
                var e = new D.a(t);
                return H(this, e, this.mathOps.length - 1, this.output, D.a);
              },
            },
            {
              key: "scale",
              value: function (t, e, n, i) {
                ...
                o =
                  4 === arguments.length
                    ...
                    : ((r = t), e);
                var s = new U.a(r, o);
                return H(this, s, this.mathOps.length - 1, this.output, U.a);
              },
            },
          ]),
          r
      ...
      Q = (function () {
        function e(t) {
          return X(this, e), L(this, z(e).call(this, t, "sine"));
        }
        return W(e, $), e;
      })(),
      J = (function () {
        function e(t) {
          return X(this, e), L(this, z(e).call(this, t, "triangle"));
        }
        return W(e, $), e;
      })(),
      K = (function () {
        function e(t) {
          return X(this, e), L(this, z(e).call(this, t, "sawtooth"));
        }
        return W(e, $), e;
      })(),
      tt = (function () {
        function e(t) {
          return X(this, e), L(this, z(e).call(this, t, "square"));
        }
        return W(e, $), e;
      })(),
      et = $,
              ...
              a < o
                ...
                void 0 !== s &&
                  (o < s
                    ...
                    : s < o &&
                      this.control.setTargetAtTime(s, r, this._rampDecayTC));
            },
          },
          {
            key: "connect",
          ...
          },
          {
            ...
            value: function (t) {
              var e = new M.a(t),
                ...
                i = this.output;
              return p5.prototype._mathChain(this, e, n, i, M.a);
            },
          },
          {
            key: "mult",
            value: function (t) {
              var e = new D.a(t),
                n = this.mathOps.length,
                i = this.output;
              return p5.prototype._mathChain(this, e, n, i, D.a);
            },
          },
          {
            key: "scale",
            value: function (t, e, n, i) {
              var r = new U.a(t, e, n, i),
                o = this.mathOps.length,
                s = this.output;
              return p5.prototype._mathChain(this, r, o, s, U.a);
            },
          },
          {
            key: "dispose",
    ...
    var Ft = (function () {
        function n(t) {
          ...
          return (
            qt(this, n),
            ((e = Nt(this, Bt(n).call(this))).biquad =
        ...
        return (
          ...
          (function (t, e, n) {
            ...
            },
            {
              key: "dispose",
              value: function () {
                jt(Bt(n.prototype), "dispose", this).call(this),
      ...
      Dt = (function () {
        function t() {
          return qt(this, t), Nt(this, Bt(t).call(this, "lowpass"));
        }
        return Vt(t, Ft), t;
      })(),
      It = (function () {
        function t() {
          return qt(this, t), Nt(this, Bt(t).call(this, "highpass"));
        }
        return Vt(t, Ft), t;
      })(),
      Ut = (function () {
        function t() {
          return qt(this, t), Nt(this, Bt(t).call(this, "bandpass"));
        }
        return Vt(t, Ft), t;
      })(),
      Gt = Ft;
                  ...
                  (u.onload = function () {
                    if (200 === u.status)
                      a.decodeAudioData(
                        ...
                        function () {
                          var t = new y("decodeAudioData", s, o.url),
                            e =
                              "AudioContext error at decodeAudioData for " +
                              o.url;
                          n && ((t.msg = e), n(t));
                      ...
                      var t = new y("loadConvolver", s, o.url),
                        e =
                          "Unable to load " +
                          o.url +
                          ". The request status was: " +
    ...
    p5.prototype.setBPM = function (t, e) {
      for (var n in ((Ve = t), p.parts)) p.parts[n] && p.parts[n].setBPM(t, e);
    };
    function Me(t, e, n) {
      Be(this, Me),
        (this.phraseStep = 0),
    ...
    var Fe = (function () {
      ...
      De = (function () {
        function n() {
          Be(this, n), (this.parts = []), (this.currentPart = 0);
          var t = this;
          ...
          },
          {
            ...
            value: function (t, e) {
              if ("number" == typeof t) {
                ...
                (this.amount = t), (this.waveShaperNode.curve = un(n));
              }
    ...
    var mn = (function () {
      function s(t, e, n, i, r, o) {
        return (
          ...
          fn(this, dn(s).call(this, t, e, n, i, r, o))
        );
      }
      return (
        (function (t, e) {
        ...
        return (
          ...
          ((t = (function (t, e) {
            return !e || ("object" !== gn(e) && "function" != typeof e)
              ? Tn(t)
              : e;
          })(this, xn(e).call(this))).oscillator = new et()),
          (t.env = new ot()),
          t.env.setRange(1, 0),
          t.env.setExp(!0),
          ...
          t.oscillator.start(),
          t.connect(),
          p.soundArray.push(Tn(t)),
          Object.defineProperties(Tn(t), {
            attack: {
              get: function () {
      ...
      return (
        ...
        (function (t, e, n) {
          ...
          },
          {
            key: "dispose",
            value: function () {
              wn(xn(e.prototype), "dispose", this).call(this),
      ...
      return (
        (function (t, e, n) {
          ...
          },
          {
            key: "play",
            value: function (t, e, n, i) {
              var r = 1 < arguments.length && void 0 !== e ? e : 0.1,
                o = 2 < arguments.length && void 0 !== n ? n : 0,
                s = 3 < arguments.length && void 0 !== i ? i : 1;
              this.noteAttack(t, r, o), this.noteRelease(t, o + s);
            },
          },
          {
            key: "noteADSR",
          ...
          },
          {
            ...
            value: function (t, e, n) {
              ...
              if (
                ...
                i = this._oldest;
                var u = this.audiovoices[this._oldest].oscillator.freq().value;
                this.noteRelease(u),
                  (this._oldest = (this._oldest + 1) % (this.maxVoices - 1));
              }
              (this.notes[s] = new it.a()), this.notes[s].setValueAtTime(i, o);
              var c =
                null === this._voicesInUse._searchBefore(o)
                  ? 0
                  : this._voicesInUse._searchBefore(o).value;
              if (
                (this._voicesInUse.setValueAtTime(c + 1, o),
                this._updateAfter(o, 1),
                (this._newest = i),
                "number" == typeof a)
              ) {
                var l = (1 / this._voicesInUse.getValueAtTime(o)) * 2;
                a = l < a ? l : a;
              }
          ...
          },
          {
            ...
            value: function (t, e) {
              var n = p.audiocontext.currentTime,
                ...
                r = n + i;
              if (!t) {
                for (var o in (this.audiovoices.forEach(function (t) {
                  t.triggerRelease(i);
                }),
                this._voicesInUse.setValueAtTime(0, r),
                this.notes))
                  this.notes[o].dispose(), delete this.notes[o];
                return (this._newest = 0), void (this._oldest = 0);
              }
              var s = h(t);
              if (this.notes[s] && null !== this.notes[s].getValueAtTime(r)) {
                var a = Math.max(~~this._voicesInUse.getValueAtTime(r), 1);
                this._voicesInUse.setValueAtTime(a - 1, r),
                  0 < a && this._updateAfter(r, -1),
                  this.audiovoices[
                    this.notes[s].getValueAtTime(r)
                  ].triggerRelease(i),
                  this.notes[s].dispose(),
                  delete this.notes[s],
                  (this._newest =
                    0 === this._newest
                      ? 0
    ...
    (p5.prototype.getAudioContext = c.b),
      ...
      (p5.prototype.disposeSound = function () {
        for (var t = p.soundArray.length - 1; 0 <= t; t--)
      ...
      (p5.prototype.writeUTFBytes = l),
      (p5.prototype.safeBufferSize = d),
